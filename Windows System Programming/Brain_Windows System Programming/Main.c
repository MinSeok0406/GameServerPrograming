...
int _tmain(int argc, TCHAR* argv[])
{
    ...
    TCHAR command1[] = _T("Command_Prompt_Practice.exe 1 5");
    TCHAR command2[] = _T("Command_Prompt_Practice.exe 6 10");
    ...
    HANDLE pi[2] = {pi1.hProcess, pi2.hProcess};
    ...
    WaitForMultipleObjects(sizeof(pi) / sizeof(HANDLE), pi, TRUE, INFINITE);
